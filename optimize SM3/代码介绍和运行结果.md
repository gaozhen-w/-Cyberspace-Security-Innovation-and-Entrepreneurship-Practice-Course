...
由用户输入想要寻找的碰撞的长度，利用get_num函数得到想要的长度的随机数。

之后运行，得到我们最终的hash值：

![image](https://user-images.githubusercontent.com/92255066/180750222-d567799e-0b46-423f-b1d5-1e59cf1f2fe5.png)


# 代码运行全过程截图：

在示例中，我们选择随机数长度为10，之后调用类，得到此随机数的hash值。

然后进行正确性检验，选择同样长度为10的一串数字，验证可得确实为随机数。

![image](https://user-images.githubusercontent.com/92255066/180750561-4ef1a0e6-4c66-489d-8723-62458090e626.png)
